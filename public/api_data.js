define({ "api": [
  ...
  {
    "type": "fanout",
    "url": "notifications/question-data",
    "title": "Notificar pregunta contestada",
    "group": "RabbitMQ_POST",
    "description": "<p>Notifica al servicio de notificaciones cuando una pregunta ha sido contestada</p>",
    "examples": [
      {
        "title": "Mensaje",
    ...
    "name": "FanoutNotificationsQuestionData"
  },
  {
    "type": "get",
